...
import { Icon, Divider, Container, Loader, Header, Grid, Image, Label } from 'semantic-ui-react';
          ...
          <Grid centered columns={2} >
            ...
            <Grid.Column width={8}>
              <Grid.Row>
                <Grid columns='equal'>
                  <Grid.Column width={8}>
                    <Header inverted as='h3' ><Icon inverted name='book'/>Skills</Header>
              ...
              <Grid.Row>
                <Grid columns={2}>
                  ...
                  <Grid.Column>
                    <Header as='h4' inverted>{this.props.student.state}</Header>
                  </Grid.Column>
                </Grid>
              </Grid.Row>
              <Divider/>
              <Grid.Row>
                <Header as='h3' inverted>
                  <div>
                    <Icon name='terminal' size='small'/>Bio
                  </div>
                </Header>
