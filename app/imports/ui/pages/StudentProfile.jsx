...
import { Segment,Divider, Container, Loader, Header, Grid, Image, Label, Message } from 'semantic-ui-react';
      ...
      <Container id="student-profile-page">
	    ...
	    <Grid.Column width={8}>
	      ...
	      <Grid.Row>
	          <Grid columns={2}>
                     <Grid.Column>
                        <Header as='h3' inverted>Location Preference</Header>   
	             </Grid.Column>
	             <Grid.Column>
	      ...
	      <Divider/>
	      <Grid.Row>
                  <Header as='h3' inverted> Bio </Header>
