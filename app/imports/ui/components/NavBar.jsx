    ...
    return (
      <Menu attached="top" borderless className='menu-background'>
        ...
        {this.props.currentUser ? (
          [<Menu.Item as={NavLink} id="homeMenuItem" activeClassName="active" exact to="/student-home" key='home' style={{ color: 'white' }}>Student Home</Menu.Item>,
            <Menu.Item as={NavLink} id="homeMenuItem" activeClassName="active" exact to="/company-home" key='home' style={{ color: 'white' }}>Company Home</Menu.Item>]
        ) : ''}
